<template> 
    <section id="teachers" class="relative">
        ...
        <img src="/assess/icon/Bg-2.svg" alt="Online Learning" class="right-20 absolute z-0 rotate-90 md:block hidden" />
...
:deep(.swiper-pagination) {
    margin-bottom: -10px; /* Abstand nach oben */
}
</style>